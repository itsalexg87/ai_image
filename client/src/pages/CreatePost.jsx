	...
	return (
		<section className="max-w-7xl mx-auto">
			<Banner
				...
				subtitle="Create nice images with DALL-E AI"
			/>
			<form className="mt-16 max-w-3xl" onSubmit={handleSubmit}>
				<div className="flex flex-col gap-5">
					...
					<FormField
						...
						type="text"
						name="prompt"
						placeholder="A green elephant playing the piano"
						value={form.prompt}
						handleChange={handleChange}
						isSurprise
				...
				<div className="mt-10">
					...
					<button
						type="submit"
						className="mt-3 text-white bg-[#6469ff] font-medium rounded-md text-sm w-full sm:w-auto px-5 py-2.5 text-cen">
